...
If you're using Python and need performance there are a variety of options - see [quantecon](http://quant-econ.net/py/need_for_speed.html) for a detailed comparison. Of course you could always choose a different language, like Julia (see [quantecon](http://quant-econ.net/python_or_julia.html)).  
