...
excerpt: "Pandas syntax is annoying. Pivotal borrows from R and SQL to offer a new syntax for data analysis in Python"
modified: 2026-04-22
tags: [Python, data, Pivotal]
comments: true
og_image: /images/pivotal_v_py.PNG
---
...
<div class="tab-bar" data-tab-group="ex1">
<button class="tab-btn active" onclick="pvtlTab(this,'ex1-pivotal')">Pivotal</button>
<button class="tab-btn" onclick="pvtlTab(this,'ex1-pandas')">Python (Pandas)</button>
<button class="tab-btn" onclick="pvtlTab(this,'ex1-polars')">Python (Polars)</button>
</div>

<div id="ex1-pivotal" class="tab-panel active" data-tab-group="ex1" markdown="1">
...
```pivotal
%%pivotal
load "invoices.csv" as invoices                 # Load data from csv file
load "customers.csv" as customers

with invoices                                   # Modify table in-place
    filter invoice_date >= "1970-01-16"
    transaction_fees = 0.8
    income = total - transaction_fees
    filter income > 1

with invoices as summary                        # Create new table from existing
...
save "my_analysis"                              # Save both tables to data package
    path "~/projects/output"
```

</div>

<div id="ex1-pandas" class="tab-panel" data-tab-group="ex1" markdown="1">
...
<div id="ex1-polars" class="tab-panel" data-tab-group="ex1" markdown="1">
...
<div class="tab-bar" data-tab-group="ex2">
<button class="tab-btn active" onclick="pvtlTab(this,'ex2-pivotal')">Pivotal</button>
<button class="tab-btn" onclick="pvtlTab(this,'ex2-pandas')">Python (Pandas)</button>
</div>

<div id="ex2-pivotal" class="tab-panel active" data-tab-group="ex2" markdown="1">
...
<div id="ex2-pandas" class="tab-panel" data-tab-group="ex2" markdown="1">
...
It would be misleading to say I've built Pivotal myself, given the involvment of AI agents (Claude and Codex) which at this point feel more like collaborators than servants. This project is well suited to AI given LLMs have been trained on so much SQL and Python already, and it's easy to define objective tests for language parsing and execution. There is a lot more to say about all this, including whether better syntax even matters if AI is doing all the coding (it does), but I'll leave that for another time.
